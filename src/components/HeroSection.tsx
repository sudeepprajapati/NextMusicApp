    ...
    return (
        ...
        >
            ...
            <div className="p-4 relative z-10 w-full text-center">
                <h1 className="mt-20 md:mt-4 text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">Master the art of music</h1>
